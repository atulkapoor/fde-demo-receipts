...
2. **Sample**: fresh items from live data -- never the golden set (the system has seen those 77 in CI). Size to match the golden set or 30, whichever is larger.
...
- `golden.jsonl`: 77 cases, sha256 `68a65b699c0f58ac`
- `edge_case.jsonl`: 7 cases, sha256 `44498ff2fb8a9166`
- `adversarial.jsonl`: 10 cases, sha256 `03e1772d7c97aad8`
- holdout: 30 cases, sha256 `07c866036535eb81` -- kept with the engagement, never shipped; fde implement --holdout must be given the file with this digest
